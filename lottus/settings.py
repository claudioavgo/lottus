"""
Django settings for lottus project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','lottuscultive.azurewebsites.net', 'https://lottus.azurewebsites.net']
...
INSTALLED_APPS = [
    'lottusApp.apps.LottusappConfig',
...
WSGI_APPLICATION = 'lottus.wsgi.application'
